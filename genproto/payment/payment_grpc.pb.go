...
type PaymentClient interface {
	...
	GetByIdPayments(ctx context.Context, in *GetById, opts ...grpc.CallOption) (*GetByIdResponse, error)
...
func (c *paymentClient) CreatePayments(ctx context.Context, in *CreatePayment, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/payment.Payment/CreatePayments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) GetByIdPayments(ctx context.Context, in *GetById, opts ...grpc.CallOption) (*GetByIdResponse, error) {
	out := new(GetByIdResponse)
	err := c.cc.Invoke(ctx, "/payment.Payment/GetByIdPayments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) UpdatePayments(ctx context.Context, in *UpdatePayment, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/payment.Payment/UpdatePayments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServer interface {
	...
	GetByIdPayments(context.Context, *GetById) (*GetByIdResponse, error)
...
func (UnimplementedPaymentServer) GetByIdPayments(context.Context, *GetById) (*GetByIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByIdPayments not implemented")
}
...
func _Payment_CreatePayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.Payment/CreatePayments",
	}
...
func _Payment_GetByIdPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetById)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServer).GetByIdPayments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.Payment/GetByIdPayments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).GetByIdPayments(ctx, req.(*GetById))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Payment_UpdatePayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.Payment/UpdatePayments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Payment_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetByIdPayments",
			Handler:    _Payment_GetByIdPayments_Handler,
		},
		{
